  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center gap-2">
        <Button variant="outline" size="icon" onClick={() => shiftPeriod(-1)} title="Previous period">
        ...
        <div className="flex flex-1 items-center gap-2 min-w-0">
          ...
          <span className="mt-4 text-muted-foreground text-sm shrink-0">-</span>
          <div className="space-y-0.5 flex-1 min-w-0">
      ...
      <p className="text-xs text-muted-foreground">{INVOICE_CYCLE_DAYS}-day billing cycle</p>
    </div>
  );
}